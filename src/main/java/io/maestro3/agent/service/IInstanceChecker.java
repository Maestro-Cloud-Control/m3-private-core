...
public interface IInstanceChecker<TENANT extends ITenant, REGION extends IRegion> {

    void checkInstances(TENANT tenant, REGION region, List<SdkInstance> instances);
